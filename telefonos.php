    ...
    <main>
        ...
        <section class="productos-destacados">
            ...
            <div class="productos-grid">
                <div class="producto" data-nombre="Iphone 16 Pro Max">
                    <img src="https://tiendasishop.com/media/catalog/product/i/p/iphone_16_pro_max_desert_titanium_pdp_image_position_1__gens.jpg?optimize=high&bg-color=255,255,255&fit=bounds&height=700&width=700&canvas=700:700"
                        alt="Iphone 16 Pro Max">
                    <p>Precio: $1719.00</p> <!-- Precio del Producto 1 -->
                    <p>iPhone 16 Pro Max - 256GB - Titanio del Desierto.</p> <!-- Descripción del Producto 1 -->
                ...
                <div class="producto" data-nombre="Iphone 16 Pro">
